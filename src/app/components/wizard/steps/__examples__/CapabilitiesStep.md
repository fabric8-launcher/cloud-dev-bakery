...
const props = {
    ...
    fetchCapabilities: () => {},
    stepId: 'capabilities-step',
    context: { capabilities: state.selectedCapabilities },
    status: {
        completed: false,
        locked: false,
        selected: true,
    ...
    updateStepContext: ({context}) => {
        setState({ selectedCapabilities: context.capabilities })
    }
};
<Wizard>
    <CapabilitiesStep {...props}/>
</Wizard>
```